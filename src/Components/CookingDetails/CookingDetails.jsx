...
const CookingDetails = ({wantToCook}) => {
    return (
            ...
            <div className="border-[1px] border-[#28282833] rounded-2xl">
                <div>
                    ...
                    <table className="w-full mt-6">
                        ...
                        <tbody>
                            {
                                wantToCook.map((items , index) => <WantToCook key={items.recipe_id} index={index} items={items}></WantToCook>)
                            }
                        </tbody>
                    </table>
                </div>
                <div className="pb-10 md:pb-12">
                    <h3 className="text-[#282828] font-lexend text-2xl font-semibold leading-7 text-center w-10/12 mx-auto pb-4 pt-8 border-b-[1px] border-[#28282826]">Currently cooking: <span>02</span></h3>
                    <table className="w-full mt-6">
                        <thead>
